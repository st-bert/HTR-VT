...
class ResNet18(nn.Module):
    ...
    def __init__(self, nb_feat=384):
        ...
        self.layer1 = self._make_layer(BasicBlock, nb_feat // 8, 2, stride=1)
        self.layer2 = self._make_layer(BasicBlock, nb_feat // 4, 2, stride=1)
        self.layer3 = self._make_layer(BasicBlock, nb_feat // 2, 2, stride=1)
        self.layer4 = self._make_layer(BasicBlock, nb_feat, 2, stride=1)
