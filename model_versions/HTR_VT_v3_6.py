...
class DecoderBlock(nn.Module):
    def __init__(self, embed_dim, num_heads=8, mlp_ratio=4.0, drop=0.0):
        super().__init__()
...
class SimpleAttentionDecoder(nn.Module):
    def __init__(self, embed_dim, max_seq_length, total_classes, num_heads=8, mlp_ratio=4.0, num_layers=2, drop=0.0):
        super().__init__()
        ...
        self.decoder_blocks = nn.ModuleList([
            DecoderBlock(embed_dim, num_heads, mlp_ratio, drop) 
